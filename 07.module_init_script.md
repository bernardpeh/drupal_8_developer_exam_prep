We can do something when the module is being installed.

create a file called modulename.install.yml.

say we want to create a new table when the module is installed.
